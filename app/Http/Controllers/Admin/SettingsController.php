...
class SettingsController extends Controller
{
    ...
    public function tiwilio()
    {
        return view('backend.settings.pages.tiwilio');
    }

    public function tiwilioUpdate(Request $request)
    {
        ...
        envUpdate('TWILIO_SID', $request->twilio_sid);
        envUpdate('TWILIO_AUTH_TOKEN', $request->twilio_auth_token);
        envUpdate('TWILIO_WHATSAPP_NUMBER', $request->twilio_whatsapp_number);
