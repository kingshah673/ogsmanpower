...
class Agency extends Model implements HasMedia
{
    ...
    protected static function booted()
    {
        static::created(function ($agency) {
            $agency->applicationGroups()->createMany([
                [
                    'name' => 'No Group',
                    'order' => 1,
                    'is_deleteable' => false,
...
public function assignedSubAgencyJobs()
{
    return $this->belongsToMany(
        \App\Models\Job::class,
        'job_sub_agencies',
    ...
    /**
     * Get the candidates registered/managed by this agency.
     */
    public function candidates(): HasMany
    {
        return $this->hasMany(Candidate::class, 'agency_id');
    }
    ...
    {
        return $this->hasMany(AgencyAttribute::class);
    }
    /**
     * Get the Agency bookmarked candidates
     *
     * @return HasMany
     */
    public function bookmarkCandidates()
    {
        return $this->belongsToMany(Candidate::class, 'bookmark_agency')->with('user')->withPivot('category_id')->withTimestamps();
    }
    ...
    {
        return $this->hasOne(AgencyBookmarkCategory::class, 'agency_id');
    }
     ...
     */
    public function bookmarkCandidateAgency()
    {
        return $this->belongsToMany(Candidate::class, 'bookmark_candidate_agency');
    }
    ...
    {
        return $this->hasOne(UserPlan::class, 'agency_id');
    }
    ...
    {
        return $this->hasMany(Earning::class, 'agency_id');
    }
    ...
    {
        return $this->hasMany(ApplicationGroup::class, 'agency_id');
    }
    ...
    {
        return $this->hasMany(CandidateCvView::class, 'agency_id');
    }

    public function questions()
    {
        return $this->hasMany(AgencyQuestion::class);
    }
