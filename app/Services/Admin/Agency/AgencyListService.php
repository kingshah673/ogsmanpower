...
class AgencyListService
{
    ...
    public function execute($request): mixed
    {
        ...
        $companies = $query->with('organization.translations', 'user')->paginate(10)->through(function ($agency) {
            $agency->active_jobs = Job::where('agency_id', $agency->id)->openPosition()->count();
