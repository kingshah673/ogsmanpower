            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div id="example1_wrapper" class="">
                            ...
                            <div class="col-md-12">
                                @if(!$agency->getFirstMedia('document'))
                                ...
                                @else
                                        ...
                                        <div class="form-group col-8" style="margin-left: auto ; margin-right: auto">
                                            ...
                                            <input name="document" type="file"
                                                   ...
                                                   data-default-file="{{ $agency->getFirstMedia('document') ? $agency->getFirstMedia('document')->getFullUrl() : ""  }}"
                                                   {{ $agency->getFirstMedia('document') ? "disabled='disabled'"  : '' }}
                                                   class="dropify">
                                            <form class="my-4" action="{{route('agency.verify.documents.download',$agency)}}" method="POST">
                                                @csrf
                                            ...
                                            <label for="document_verify" style="display: flex">
                                                ...
                                                <input id="document_verify"
                                                       {{ $agency->document_verified_at ? 'checked' : ''  }}
    ...
    <script>
        $('#document_verify').on('change', function() {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: '{{ route('admin.agency.document.verify.change',$agency) }}',
