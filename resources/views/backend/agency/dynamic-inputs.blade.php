    ...
    @if (userCan('agency.create'))
        <div class="container-fluid">
            ...
            <div class="container-fluid" id="dynamic-inputs-list">
                @foreach ($agency_attribute as $attribute)
    ...
    <script>
        ...
        function addDynamicInput() {
            ...
            if (inputLabel && inputType) {
                $.ajax({
                    url: "{{ route('agency.add_dynamic_input') }}",
                    method: "POST",
                    data: {
                        label: inputLabel,
                        type: inputType,
        ...
        function deleteInput(id) {
            if (confirm("Are you sure you want to delete this input?")) {
                $.ajax({
                    url: "{{ route('agency.delete_dynamic_input', '') }}/" + id,
                    method: "DELETE",
                    data: {
                        _token: "{{ csrf_token() }}"
                    },
        ...
        function toggleActive(id, isActive) {
            $.ajax({
                url: "{{ route('agency.toggle_active') }}",
                method: "POST",
                data: {
                    id: id,
                    is_active: isActive,
        ...
        function toggleRequired(id, isRequired) {
            $.ajax({
                url: "{{ route('agency.toggle_required') }}",
                method: "POST",
                data: {
                    id: id,
