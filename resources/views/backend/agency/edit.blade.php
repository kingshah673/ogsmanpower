...
@section('content')
    <div class="container-fluid">
        <form class="form-horizontal" action="{{ route('agency.update', $agency->id) }}" method="POST"
                    ...
                    <div class="card">
                        ...
                        @else
                            @php
                                ...
                                session([
                                    'selectedCountryId' => $agency->country,
                                    'selectedStateId' => $agency->region,
                                    'selectedCityId' => $agency->district,
                                ]);
                            @endphp
                            ...
                            <div class="row">
                                <div class="form-group col-xl-4">
                                    ...
                                    <input name="logo" type="file" data-show-errors="true" data-width="50%"
                                        class="dropify" data-default-file="{{ $agency->logo_url }}">
                                ...
                                <div class="form-group col-xl-8">
                                    ...
                                    <input name="image" type="file" data-show-errors="true" data-width="100%"
                                        data-default-file="{{ $agency->banner_url }}" class="dropify">
                                    <p class="tw-text-gray-500 tw-text-xs tw-text-left mt-2 recommended-img-note mb-0">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="organization_type_id"
                                        ...
                                        @foreach ($organization_types as $type)
                                            <option
                                                {{ $type->id == old('organization_type_id', $agency->organization_type_id) ? 'selected' : '' }}
                                                value="{{ $type->id }}">
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="industry_type_id"
                                        ...
                                        @foreach ($industry_types as $type)
                                            <option
                                                {{ $type->id == old('industry_type_id', $agency->industry_type_id) ? 'selected' : '' }}
                                                value="{{ $type->id }}">
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="team_size_id" class="form-control {{ error('team_size_id') }}"
                                        ...
                                        @foreach ($team_sizes as $size)
                                            <option
                                                {{ $size->id == old('team_size_id', $agency->team_size_id) ? 'selected' : '' }}
                                                value="{{ $size->id }}">
                                                {{ $size->name }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="form-group datepicker col-md-6">
                                    ...
                                    <x-forms.input type="text" name="establishment_date" placeholder="select_one"
                                        ...
                                        value="{{ old('establishment_date', formatTime($agency->establishment_date, 'd-m-Y')) }}" />
                                    <x-forms.error name="establishment_date" />
                                </div>
                            </div>
                            <div class="row">
...
@section('script')
    ...
    {{-- Leaflet  --}}
    @include('map::set-edit-leafletmap', ['lat' => $agency->lat, 'long' => $agency->long])
