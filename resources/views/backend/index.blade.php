    ...
    <div class="row">
            ...
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                        ...
                        @if ($data['earnings'] == null || $data['earnings'] == 0)
                            0
                        @endif
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">{{ __('agents') }}</span>
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">{{ __('featured_jobs') }}</span>
                    <span class="info-box-number">{{ 0 }}</span>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">{{ __('feat_company') }}</span>
                    <span class="info-box-number">{{ 0 }}</span>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                <span class="info-box-icon bg-black elevation-1"><i class="fas fa-dollar-sign"></i></span>

                <div class="info-box-content">
                    <span class="info-box-text">{{ __('total_earnings') }}</span>
                    <span class="info-box-number">{{ 0 }}</span>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">{{ __('countries') }}</span>
                    <span class="info-box-number">{{ 0 }}</span>
                </div>
            </div>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-muted">
                                            @if ($earning->payment_type == 'per_job_based')
                                                <span
                                                    class="badge badge-secondary">{{ ucfirst(Str::replace('_', ' ', $earning->payment_type)) }}</span>
                                            @else
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">{{ __('Total Cv Posted') }}</span>
                    <span class="info-box-number">{{ $data['verified_users'] }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">{{ __('Selected Candidates') }}</span>
                    <span class="info-box-number">{{ $data['companies'] }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">{{ __('Rejected Candidates') }}</span>
                    <span class="info-box-number">{{ 0 }}</span>
                </div>
            </div>
        </div>
