...
<form action="{{ route('agency.profile.complete', auth()->user()->id) }}" method="post">
    ...
    <fieldset>
                    ...
                    <div class="col-12 custom-select-padding">
                        <div class="d-flex">
                            <div class="d-flex mborder">
                                ...
                                <div class="w-100">
                                    <input class="border-0" type="text" name="url[]" id="" placeholder="{{ __('profile_link_url') }}..." value="{{ $social->url }}">
                                </div>
                            </div>
                            <div class="tw-ms-2">
                    ...
                    <div class="col-12 custom-select-padding">
                        <div class="d-flex">
                            <div class="d-flex mborder">
                                ...
                                <div class="w-100">
                                    <input class="border-0" type="text" name="url[]" id="" placeholder="{{ __('profile_link_url') }}...">
                                </div>
                            </div>
                            <div class="tw-ms-2">
                                <button class="btn btn-primary2-50 cross-btn" type="button" id="remove_item">
        ...
        @unless($longForm)
        <a href="{{ url('agency/account-progress?profile') }}">
