...
@php
    $bannerOnDisk = $user->agency?->bannerFileExists();
@endphp
<div class="col-lg-8">
    ...
    <div  id="banner-oldMode" class="{{ $bannerOnDisk ? '' : 'd-none' }} banner-file-upload-content2">
        <img class="banner-file-upload-image" src="{{  $user->agency->banner_url }}"
            alt="your image" />
    ...
    <p class="tw-text-gray-500 tw-text-xs tw-text-left mt-2">Image Size: 1920x312</p>
    @error('banner')
