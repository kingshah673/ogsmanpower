...
<div class="sidebar-widget">
    <div class="contact">
        ...
        @if ($user->agency->website)
            <div class="contact-icon-box">
                ...
                <div class="info">
                    ...
                    <a href="{{ $user->agency->website }}" target="_blank" class="title">{{ $user->agency->website }}</a>
                </div>
            </div>
            <div class="devider">
                <hr>
        ...
        <div class="contact-icon-box">
            ...
            <div class="info">
                ...
                <h2 class="title">
                    {{ $user->agency->exact_location ? $user->agency->exact_location: $user->agency->full_address }}
                </h2>
            </div>
        </div>
    ...
    <div id="show-more" data-bs-toggle="collapse" data-bs-target="#contact-more-collapse" aria-expanded="false"
        aria-controls="contact-more-collapse" class="@guest login_required @endguest mt-2 rounded show-more">
        {{ __('show_contact_information') }}
    </div>
</div>
