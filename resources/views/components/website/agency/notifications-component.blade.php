<li>
    <div class="notification-icon relative pointer position-relative tw-text-white">
        ...
        @if (agencyUnreadNotifications() > 0)
        ...
        <div class="notification-bar">
                    ...
                    @if ($notifications->count() > 0)
                        @php
                            $knownNotificationTypes = [
                                'App\Notifications\Website\Candidate\ApplyJobNotification',
                                'App\Notifications\Website\Agency\PaymentMarkPaidNotification',
                                'App\Notifications\Website\Candidate\BookmarkJobNotification',
                                'App\Notifications\Website\Agency\CandidateBookmarkNotification',
                                'App\Notifications\Website\Agency\JobCreatedNotification',
                                'App\Notifications\Website\Agency\EditApproveNotification',
                                'App\Notifications\Website\Agency\JobDeletedNotification',
                                'App\Notifications\JobApprovalNotification',
                                'App\Notifications\SendProfileVerifiedNotification',
                            ];
                        @endphp
                        @foreach ($notifications as $noti)
                            @if ($noti->type == 'App\Notifications\Website\Candidate\ApplyJobNotification')
                                <li>
                                    <a onclick="readSingleNotification('{{ route('agency.dashboard') }}', '{{ $noti->id }}')"
                            ...
                            @endif
                            @if ($noti->type == 'App\Notifications\Website\Agency\PaymentMarkPaidNotification')
                                <li>
                                    <a onclick="readSingleNotification('{{ $noti->data['url'] }}', '{{ $noti->id }}')"
                                        ...
                                        <div class="notification-thumb">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                                                fill="#000000" viewBox="0 0 256 256">
                                                <rect width="256" height="256" fill="none"></rect>
                                                <line x1="128" y1="72" x2="128" y2="88"
                                                    fill="none" stroke="#000000" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="16">
                                                </line>
                                                <line x1="128" y1="168" x2="128" y2="184"
                                                    fill="none" stroke="#000000" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="16"></line>
                                                <circle cx="128" cy="128" r="96" fill="none"
                                                    stroke="#000000" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="16"></circle>
                                                <path d="M104,168h36a20,20,0,0,0,0-40H116a20,20,0,0,1,0-40h36"
                                                    fill="none" stroke="#000000" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="16"></path>
                                            </svg>
                                        </div>
                            ...
                            @if ($noti->type == 'App\Notifications\Website\Candidate\BookmarkJobNotification')
                                <li>
                                    <a onclick="readSingleNotification('{{ $noti->data['url'] }}', '{{ $noti->id }}')"
                                        ...
                                        <div class="notification-thumb">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                                                fill="blue" viewBox="0 0 256 256">
                                                <rect width="256" height="256" fill="none"></rect>
                                                <path d="M192,224l-64-40L64,224V48a8,8,0,0,1,8-8H184a8,8,0,0,1,8,8Z"
                                                    fill="blue" stroke="blue" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="16"></path>
                                            </svg>
                                        </div>
                                        <div class="">
                            ...
                            @endif
                            @if ($noti->type == 'App\Notifications\Website\Agency\CandidateBookmarkNotification')
                                <li>
                            ...
                            @endif
                            @if ($noti->type == 'App\Notifications\Website\Agency\JobCreatedNotification' ||
                                $noti->type == 'App\Notifications\Website\Agency\EditApproveNotification' ||
                                $noti->type == 'App\Notifications\Website\Agency\JobDeletedNotification')
                                <li>
                                    <a onclick="readSingleNotification('{{ $noti->data['url'] }}', '{{ $noti->id }}')"
                                        href="javascript:void(0)" class="d-flex">
                                        <div class="notification-thumb">
                            ...
                            @endif
                            @if ($noti->type == 'App\Notifications\SendProfileVerifiedNotification')
                                    <li>
                                        <a
                                            onclick="readSingleNotification('{{ $noti->data['url'] }}', '{{ $noti->id }}')"
                            ...
                            @if (!in_array($noti->type, $knownNotificationTypes) && !empty($noti->data['title']))
                                <li>
                                    <a onclick="readSingleNotification('{{ $noti->data['url'] ?? '#' }}', '{{ $noti->id }}')"
                                        href="javascript:void(0)" class="d-flex">
                                        <div class="notification-thumb">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                                                ...
                                                <circle cx="128" cy="128" r="96" fill="none"
                                                    stroke="#000000" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="16"></circle>
                                                <line x1="128" y1="72" x2="128" y2="144" fill="none"
                                                    stroke="#000000" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="16"></line>
                                                <circle cx="128" cy="180" r="4" fill="#000000"></circle>
                                            </svg>
                                        </div>
                                        <div class="">
                                            <h4>{{ $noti->data['title'] }}</h4>
            ...
            @if ($notifications->count() > 6)
                <div class="text-center bg-gray-50 p-2">
                    <a href="{{ route('agency.allNotification') }}">
