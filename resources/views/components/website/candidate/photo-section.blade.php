<x-forms.label name="profile_picture"
    ...
    <div id="photo-uploadMode" class="{{ $candidate->photo ? 'd-none' : '' }}">
        ...
        <div class="profile-file-upload-content">
            <img class="profile-file-upload-image rounded-circle" src="#"
                alt="your image" style="width: 164px; height: 164px; object-fit: cover;" />
    ...
    <div id="photo-oldMode" class="{{ $candidate->photo ? '' : 'd-none' }}">
        <div class="profile-file-upload-content2">
            <img class="profile-file-upload-image rounded-circle" src="{{ asset($candidate->photo) }}"
                alt="your image" style="width: 164px; height: 164px; object-fit: cover;" />
    ...
    <p class="tw-text-gray-500 tw-text-xs tw-text-left mt-2">Image Size: 164x164</p>
