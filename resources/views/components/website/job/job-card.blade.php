...
@endif
        ...
        <div class="tw-flex tw-items-center tw-absolute tw-bottom-6 !tw-right-6">
            <!-- Bookmark Icon -->
            <div class="text-primary-500 hoverbg-primary-50 plain-button icon-button tw-mr-2">
                @auth
                    @if (auth()->user()->role == 'candidate')
                        <a href="{{ route('website.job.bookmark', $job->slug) }}" class="tw-text-[#C8CCD1]">
                            @if ($job->bookmarked)
                                <x-svg.bookmark-icon width="20" height="20" fill="#0A65CC" stroke="#0A65CC" />
                            @else
                                <x-svg.unmark-icon />
                            @endif
                        </a>
            ...
            <div class="tw-relative tw-z-50">
                {{-- <button
                    class="tw-inline-flex tw-items-center tw-bg-[#E7F0FA] tw-text-[#0A65CC] hover:tw-bg-[#0A65CC] hover:tw-text-white tw-rounded-[4px] tw-p-1.5"
                    onclick="toggleDropdown(this)">
                    <x-svg.share-icon width="16" height="16" />
                </button> --}}
                <button
                    class="tw-inline-flex tw-items-center tw-bg-[#E7F0FA] tw-text-[#0A65CC] hover:tw-bg-[#0A65CC] hover:tw-text-white tw-rounded-[4px] tw-p-1.5"
                ...
                <!-- Dropdown -->
                <ul
                    class="tw-list-none tw-hidden tw-flex tw-bg-white tw-shadow-md tw-rounded-md tw-p-2 tw-absolute tw-left-0 tw-top-[110%] tw-z-50">
                    <li class="tw-mr-2">
                        <a href="javascript:void(0);"
                            onclick="openPopUp('{{ socialMediaShareLinks(url()->current(), 'facebook') }}')"
                            class="tw-inline-flex tw-items-center tw-p-2 hover:tw-bg-gray-100 tw-rounded-md">
                            <x-svg.new-facebook-icon width="16" height="16" />
                            <span class="tw-ml-2">Facebook</span>
                        </a>
                    </li>
                    <li class="tw-mr-2">
                        <a href="javascript:void(0);"
                            ...
                            class="tw-inline-flex tw-items-center tw-p-2 hover:tw-bg-gray-100 tw-rounded-md">
                            <x-svg.new-twitter-icon width="16" height="16" />
                            <span class="tw-ml-2">Twitter</span>
                        </a>
                    </li>
                    <li class="tw-mr-2">
                        <a href="javascript:void(0);"
                            ...
                            class="tw-inline-flex tw-items-center tw-p-2 hover:tw-bg-gray-100 tw-rounded-md">
                            <x-svg.linkedin-icon width="16" height="16" />
                            <span class="tw-ml-2">LinkedIn</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"
                            ...
                            class="tw-inline-flex tw-items-center tw-p-2 hover:tw-bg-gray-100 tw-rounded-md">
                            <x-svg.whatsapp-icon width="16" height="16" />
                            <span class="tw-ml-2">WhatsApp</span>
                        </a>
                    </li>
                </ul>
            </div>
