                    ...
                    <div class="row w-100">
                        <div class="col-md-6">
                            <a href="{{ route('website.home') }}" class="brand-logo"><img
                                    src="{{ $setting->light_logo_url }}" alt="jobpilot_logo"></a>
                        </div>
        ...
        <div class="container">
            <fieldset>
                <div class="account-successfull-wrap">
                    ...
                    <a href="{{ route('agency.dashboard') }}" class="btn bg-gray-50 rt-mr-8">
                        {{ __('view_dashboard') }}
                    </a>
                    <a href="{{ route('agency.job.create') }}" class="btn btn-primary">
