                        ...
                        <div class="db-job-card-table">
                            @if ($notifications->count() > 0)
                                ...
                                @foreach ($notifications as $noti)
                                    ...
                                    @endif
                                    @if ($noti->type == 'App\Notifications\Website\Agency\JobCreatedNotification' || $noti->type == 'App\Notifications\Website\Agency\EditApproveNotification' || $noti->type == 'App\Notifications\Website\Agency\JobDeletedNotification')
                                        <div class="card jobcardStyle1 rt-mb-12 ">
                                            <div class="card-body">
                                                <div class="rt-single-icon-box ">
                                                    <div class="iconbox-content">
