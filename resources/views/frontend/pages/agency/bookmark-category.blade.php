                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="text-end mr-2">
                                                                        <a href="{{ route('agency.bookmark.category.edit', $cat->id) }}"
                                                                        ...
                                                                        <form class="d-none"
                                                                            ...
                                                                            action="{{ route('agency.bookmark.category.destroy', $cat->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                        </form>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="post-job-item rt-mb-15">
                                            <form
                                                action="{{ request()->routeIs('agency.bookmark.category.index')
                                                    ? route('agency.bookmark.category.store')
                                                    : route('agency.bookmark.category.update', $category->id) }}"
                                                method="POST">
                                                @csrf
                                                @if (request()->routeIs('agency.bookmark.category.index'))
                                                @else
                                                    @method('PUT')
                                                @endif
                                                <div class="rt-mb-20">
                                                    ...
                                                    <input name="name"
                                                        @if (request()->routeIs('agency.bookmark.category.index')) @else value="{{ $category->name }}" @endif
                                                ...
                                                @else
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div>
                                                            <a href="{{ route('agency.bookmark.category.index') }}"
