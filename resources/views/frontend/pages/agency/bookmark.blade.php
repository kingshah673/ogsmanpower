                    ...
                    <div class="dashboard-right tw-ps-0 lg:tw-ps-3">
                        <div class="row d-flex tw-flex-wrap justify-content-between p-2">
                            ...
                            <div class="col-sm-12 col-md-6 d-flex tw-flex-wrap tw-gap-3 tw-justify-between">
                                <form id="categoryForm" action="{{ route('agency.bookmark') }}" method="GET">
                                    ...
                                    <div class="card-body">
                                        <div class="rt-single-icon-box tw-flex-wrap">
                                            ...
                                            <div class="iconbox-extra align-self-center">
                                                <div>
                                                    <form
                                                        action="{{ route('agency.agencybookmarkcandidate', $candidate->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        <button type="submit"
                                                ...
                                                <div class="rt">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end agency-dashboard-dropdown"
                        ...
                        if (experience.created_at) {
                            ...
                            <li class="tw-text-sm tw-flex tw-flex-col tw-gap-3">
                                <div class="tw-flex tw-flex-col tw-gap-1">
                                    ...
                                    <p class="tw-m-0 tw-text-sm tw-text-[#707A7D]">${experience.agency}/${experience.department}</p>
                                </div>
