    ...
    <div class="dashboard-wrapper tw-min-h-screen tw-flex tw-flex-col tw-justify-between">
        ...
        <div class="container-fluid">
            <div class="status-boxes">
                <div class="box applicants">
                    <p class="">Applicants</p>
                    <p class="count">5</p>
                </div>

                <div class="box shortlisted">
                    <p class="">Shortlisted</p>
                    <p class="count">0</p>
                </div>
                        ...
                        <div class="application-wrapper">
                            <div class="application-wrapper-top">
                                ...
                                <div class="filter-sort">
                                    ...
                                    <a href="{{ route('agency.myjob') }}" class="btn">
                                        {{ __('back') }}
                                    </a>
                                </div>
                            </div>
...
@section('script')
    <script type="text/javascript">
        function createColumn() {
            var name = $('#name').val();
            $.ajax({
                url: "{{ route('agency.applications.column.store') }}",
                type: "POST",
                data: {
                    name: name,
                    _token: '{{ csrf_token() }}'
