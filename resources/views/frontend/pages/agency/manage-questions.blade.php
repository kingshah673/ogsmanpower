                ...
                <div class="col-lg-9">
                    <div x-data="manageQuestions" class="dashboard-right tw-ps-0 lg:tw-ps-5">
                        <div class="d-flex justify-content-between tw-items-center tw-w-full tw-mb-6 lg:tw-mt-0 tw-mt-6">
                            ...
                            <form
                                action="{{route('agency.questions.featureToggle')}}"
                                method="POST"
                                id="toggle-form-id">
                                @csrf
                                <label>
                                    <input name="enableQuestion"
                                    {{ auth()->user()->agency->question_feature_enable ? 'checked' : ''  }}
                                    ...
                                    ({{ auth()->user()->agency->question_feature_enable ? 'Enable' : 'Disable' }})
                                </label>
                            </form>
                        </div>
                        <div class="tw-border tw-border-gray-200 tw-p-4 tw-rounded-lg border">
                            <form x-bind:action="{{route('agency.questions.store')}}" class="post-job-item rt-mb-15" method="POST">
                                @csrf
                                <div class="tw-mb-3">
                                                            ...
                                                            <td>
                                                                <div class="text-end mr-2">
                                                                    ...
                                                                    <form class="d-none"
                                                                          ...
                                                                          action="{{ route('agency.questions.delete', $question->id) }}"
                                                                          method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                    </form>
