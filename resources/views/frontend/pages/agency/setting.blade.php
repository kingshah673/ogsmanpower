    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-xl-10">
                ...
                <div class="card border-0 shadow-lg rounded-4 mb-4 overflow-hidden">
                    <div class="p-4 text-white"
                        ...
                        <p class="mb-0 opacity-75">
                            Manage your agency profile, branding, social links, contact information and security settings.
                        </p>
                    </div>
                </div>
                ...
                {{-- Sidebar --}}
                {{-- <x-website.agency.sidebar /> --}}

                <div class="col-lg-980">
                    <div class="dashboard-right tw-ps-0 lg:tw-ps-5 tw-mt-4 lg:tw-mt-0">
                        ...
                        <div class="cadidate-dashboard-tabs agency tw-min-h-[500px] ">
                            ...
                            <div>
                                <div class="">
                                    <form action="{{ route('agency.settingUpdateInformation') }}" method="POST"
                                        ...
                                        <div class="dashboard-account-setting-item">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 mb-3">
                                                    <x-forms.label name="agency_name" required="true"
                                    ...
                                    <div class="dashboard-account-setting-item pb-0">
                                        <form action="{{ route('agency.settingUpdateInformation') }}" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 mb-3">
                                                    ...
                                                    <select name="organization_type" class="select2-taggable w-100-p">
                                                        @foreach ($organization_types as $organization_type)
                                                            <option
                                                                {{ $user->agency->organization_type_id == $organization_type->id ? 'selected' : '' }}
                                                ...
                                                <div class="col-lg-4 mb-3">
                                                    ...
                                                    <select name="industry_type" class="select2-taggable w-100-p">
                                                        @foreach ($industry_types as $industry_type)
                                                            <option
                                                                {{ $user->agency->industry_type_id == $industry_type->id ? 'selected' : '' }}
                                                ...
                                                <div class="col-lg-4 mb-3">
                                                    ...
                                                    <select name="team_size" class="rt-selectactive w-100-p">
                                                        @foreach ($team_sizes as $team_size)
                                                            <option
                                                                {{ $user->agency->team_size_id == $team_size->id ? 'selected' : '' }}
                                                                value="{{ $team_size->id }}">
                                                    ...
                                                    <div class="fromGroup">
                                                        <div
                                                            ...
                                                            <input type="text" name="establishment_date"
                                                                value="{{ $user->agency->establishment_date ? date('d-m-Y', strtotime($user->agency->establishment_date)) : old('establishment_date') }}"
                                                ...
                                                <div class="col-lg-12 mb-3">
                                                    <x-forms.label name="agency_vision" :required="false"
                                                        class="body-font-4 d-block text-gray-900 rt-mb-8" />
                                                    <textarea name="vision" class="ckedit" id="image_ckeditor_2">{{ $user->agency->vision }}</textarea>
                                                </div>
                                                <div class="col-lg-12 mt-4">
                                                    <button type="submit" class="btn btn-primary">
                                                        {{ __('save_changes') }}
                                        ...
                                        <div class="dashboard-account-setting-item pb-0">
                                            ...
                                            @if (config('templatecookie.map_show'))
                                                <div class="row">
                                                    ...
                                                    <div
                                                        class="{{ $setting->default_map == 'leaflet' ? '' : 'd-none' }}">
                                                        <input type="text" autocomplete="off" id="leaflet_search"
                                                            placeholder="{{ __('enter_city_name') }}" class="full-width"
                                                            value="{{ $user->agency->exact_location ? $user->agency->exact_location : $user->agency->full_address }}" />
                                                        <br>
                                                ...
                                                @php
                                                    ...
                                                    $agency_country = $user->agency->country;
                                                    $agency_exact_location = $user->agency->exact_location;
                                                @endphp
                                                <div class="card-footer row mt-4 border-0">
                                                    ...
                                                    <div class="location_secion">
                                                        {{ __('country') }}: <span
                                                            class="location_country">{{ $agency_country ?: $session_country }}</span>
                                                        <br>
                                                        {{ __('full_address') }}: <span
                                                            class="location_full_address">{{ $agency_exact_location ?: $session_exact_location }}</span>
                                                    </div>
                                                </div>
                                            @else
                                                <x-website.location.country-state-city-select
                                                    prefix="agency_settings"
                                                    :selected-country="old('country', $user->agency->country)"
                                                    :selected-state="old('state', $user->agency->region)"
                                                    :selected-city="old('district', $user->agency->district)"
                                                />
                                            @endif
                                        </div>

                                        <div class="dashboard-account-setting-item">
                                            <h6>{{ __('agency_contact_public') }}</h6>
                                    ...
                                    <div class="dashboard-account-setting-item setting-border">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <form action="{{ route('agency.settingUpdateInformation') }}"
...
@section('script')
    ...
    {{-- Leaflet  --}}
    @include('map::set-edit-leafletmap', ['lat' => $user->agency->lat, 'long' => $user->agency->long])
    <script>
