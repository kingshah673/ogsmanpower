...
<div class="container-fluid mt-4">
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <a href="{{ route('agent.candidates.index') }}" class="btn btn-light">← Back</a>
    </div>

    <form action="{{ route('agent.candidates.update',$candidate->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
