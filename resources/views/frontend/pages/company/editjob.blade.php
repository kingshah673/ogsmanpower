                ...
                <div class="card border-0 shadow-lg rounded-4 mb-4 overflow-hidden">
                    <div class="p-4 text-white"
                        ...
                        <p class="mb-0 opacity-75">
                            Manage your company profile, branding, social links, contact information and security settings.
                        </p>
                    </div>
                </div>
                        ...
                        <form action="{{ route('company.job.update', $job->slug) }}" method="POST" class="rt-from">
                            ...
                            <div class="col-lg-6 mb-3" id="dynamic-inputs">
                                ...
                                @foreach ($dynamicInputs as $index => $input)
                                    @php
                                        $inputData = $inputsData->firstWhere('company_attribute_id', $input->id); // Match translation with attribute
                                        // dd($inputData);
                                    @endphp
